    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=256, verbose_name="Crawling Source Name"
                    ),
                ),
                (
                    "rss_feed_url",
                    models.URLField(blank=True, null=True, verbose_name="RSS Feed URL"),
                ),
                (
                    "fetch_interval",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="마지막 크롤링 시간", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        db_index=True, help_text="사이트의 기본 URL", unique=True
                    ),
                ),
                (
                    "license_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(unique=True, verbose_name="Crawling Article URL"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(blank=True, help_text="기사 제목", max_length=512),
                ),
                ("content", models.TextField(help_text="크롤링 본문")),
                (
                    "published_at",
                    models.DateTimeField(
                        blank=True, help_text="원문 게시 시각", null=True
                    ),
                ),
                (
                    "is_visible",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "author",
                    models.CharField(blank=True, help_text="작성자", max_length=200),
                ),
                (
                    "category",
                    models.CharField(blank=True, help_text="카테고리", max_length=200),
                ),
                (
                    "guid",
                    models.CharField(
                        blank=True, help_text="GUID", max_length=500, unique=True
                    ),
                ),
                (
                    "pub_date",
                    models.DateTimeField(blank=True, help_text="발행일", null=True),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    "feed",
