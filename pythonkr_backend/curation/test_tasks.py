...
from .tasks import crawl_all_rss_feeds, crawl_single_rss_feed, crawl_rss, crawl_rss_item_content, translate_pending_rss_item
    ...
    def test_crawl_single_rss_feed_success(self):
        ...
        mock_feed_data.entries = [
            type('Entry', (), {
                ...
                'author': "Test Author",
                'tags': [type('Tag', (), {'term': "python"})(), type('Tag', (), {'term': "django"})()],
                'id': "article1",
    ...
    def test_crawl_single_rss_feed_field_truncation(self):
        ...
        mock_feed_data.entries = [
            type('Entry', (), {
                ...
                'tags': [type('Tag', (), {'term': "tag" + str(i)})() for i in range(50)],  # Many tags
