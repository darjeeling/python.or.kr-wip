...
class TestLLMService:
    ...
    def setup_method(self):
        ...
        self.openai_service = LLMService.objects.create(
            provider="openai", priority=2, is_active=True
        )
        self.claude_service = LLMService.objects.create(
            provider="claude", priority=3, is_active=True
        )
    ...
    def test_get_available_models_for_provider_gemini_no_usage(self):
        ...
        available_models = LLMService._get_available_models_for_provider(
            "gemini", model_configs
        )
